function Link() {
  return (
    <div className="absolute h-[24.273px] left-[70px] top-[70px] w-[91.707px]" data-name="Link">
      <p className="absolute font-['Helvetica:Bold',sans-serif] leading-[22.4px] left-0 not-italic text-[22px] text-white top-[-5.13px] tracking-[-0.5px]">StyloBliss</p>
    </div>
  );
}
...
function List() {
  return (
    <div className="content-stretch flex flex-col gap-[11.995px] h-[199.457px] items-start relative shrink-0 w-full" data-name="List">
      <ListItem />
      <ListItem1 />
      <ListItem2 />
      <ListItem3 />
...
function List1() {
  return (
    <div className="content-stretch flex flex-col gap-[11.995px] h-[410.908px] items-start relative shrink-0 w-full" data-name="List">
      <ListItem6 />
      <ListItem7 />
      <ListItem8 />
      <ListItem9 />
...
function List2() {
  return (
    <div className="h-[340.424px] relative shrink-0 w-full" data-name="List">
      <ListItem18 />
      <ListItem19 />
      <ListItem20 />
      <ListItem21 />
...
function List3() {
  return (
    <div className="content-stretch flex flex-col gap-[11.995px] h-[234.699px] items-start relative shrink-0 w-full" data-name="List">
      <ListItem38 />
      <ListItem39 />
      <ListItem40 />
      <ListItem41 />
...
function List4() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[11.995px] h-[58.489px] items-start left-[29.99px] top-[65.99px] w-[150.03px]" data-name="List">
      <ListItem45 />
      <ListItem46 />
    </div>
  );
...
function Container1() {
  return (
    <div className="absolute h-[465.155px] left-[70px] top-[144.26px] w-[1160.002px]" data-name="Container">
      <Container2 />
      <Container3 />
      <Container4 />
      <Container5 />
...
function Container9() {
  return (
    <div className="absolute content-stretch flex gap-[29.992px] h-[17.997px] items-start left-[918.7px] top-0 w-[241.307px]" data-name="Container">
      <Link1 />
      <Link2 />
      <Link3 />
    </div>
...
function Container7() {
  return (
    <div className="absolute h-[17.997px] left-[70px] top-[674.42px] w-[1160.002px]" data-name="Container">
      <Container8 />
      <Container9 />
    </div>
  );
