...
function FeatureSection({ data }: { data: FeatureSectionData }) {
  const textBlock = (
    <div className="flex flex-col flex-1 max-w-full lg:max-w-[532px] w-full text-center lg:text-left items-center lg:items-start justify-center">
      ...
      {/* Heading */}
      <h2
        className="mb-[16px] md:mb-[30px] text-[rgb(25,_30,_73)] text-[28px] sm:text-[34px] md:text-[40px] tracking-[-1.32px] leading-[1.15]"
    ...
    <section className="relative w-full py-[40px] md:py-[80px] px-4 md:px-[70px]">
      <div className="mx-auto flex flex-col items-center gap-[40px] md:gap-[100px] max-w-[1160px]">
        ...
        <div className="flex flex-col items-center text-center max-w-[700px]">
          ...
          <h2
            className="mb-[16px] md:mb-[30px] text-[rgb(25,_30,_73)] text-[28px] sm:text-[36px] md:text-[44px] tracking-[-1.2px] leading-[1.15]"
            style={{ fontWeight: 700 }}
          >
            Don't just take our word for it
          </h2>
          <p
            className="text-[rgb(25,_30,_73)] text-[15px] md:text-[18px] leading-[26px] md:leading-[30px]"
    ...
    <section className="relative w-full py-[40px] md:py-[80px] px-4 md:px-[70px]">
      ...
      >
        ...
        <div className="flex flex-col items-center text-center max-w-[640px] relative z-[2] px-4 md:px-[30px]">
          <h3
            className="mb-[16px] md:mb-[20px] text-[rgb(25,_30,_73)] text-[26px] sm:text-[32px] md:text-[38px] tracking-[-1.32px] leading-[1.2]"
            style={{ fontWeight: 700 }}
          >
            Salon Tips Worth a Double Take
          </h3>
          <p
            className="mb-[24px] md:mb-[30px] text-[rgb(25,_30,_73)] text-[14px] md:text-[16px] leading-[24px] md:leading-[28px]"
            style={{ fontWeight: 500 }}
          >
  ...
  return (
    <section className="relative w-full py-[40px] md:py-[80px] px-4 md:px-[70px]">
      <div className="mx-auto flex flex-col gap-[30px] md:gap-[50px] max-w-[1160px]">
        {/* Header */}
        <h3
          className="text-center text-[rgb(25,_30,_73)] text-[26px] sm:text-[30px] md:text-[33px] tracking-[-1px] leading-[1.2]"
          style={{ fontWeight: 700 }}
        >
              ...
              <div className="flex flex-col gap-[15px]">
                {cat.items.map((item) => (
                  ...
                  >
                    ...
                    <span
                      className="text-[rgb(25,_30,_73)] text-[15px] tracking-[-0.18px] leading-[22px]"
  ...
  return (
    <section className="relative w-full py-[30px] md:py-[50px] px-4 md:px-[70px]">
      <div className="mx-auto flex flex-col items-center max-w-[760px] pt-[30px] md:pt-[50px] pb-[10px]">
        {/* Header */}
        <h3
          className="text-center text-[rgb(25,_30,_73)] text-[26px] sm:text-[30px] md:text-[33px] tracking-[-1px] leading-[1.2] mb-[24px] md:mb-[40px]"
          style={{ fontWeight: 700 }}
        >
    ...
    <section className="relative w-full py-[40px] md:py-[60px] px-4 md:px-[70px]">
      ...
      >
        ...
        <div className="flex flex-col gap-[20px] md:gap-[28px] items-center md:items-start justify-center max-w-[399px] self-stretch text-center md:text-left">
          <h2
            className="text-[rgb(25,_30,_73)] text-[28px] sm:text-[32px] md:text-[37px] tracking-[-1.25px] leading-[1.2]"
            style={{ fontWeight: 700 }}
          >
