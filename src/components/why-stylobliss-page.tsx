    ...
    <div style={{ ...SV, background: '#ffffff' }}>
      ...
      <section className="relative w-full pt-[120px] md:pt-[160px] pb-[60px] md:pb-[100px] px-4 md:px-[70px]">
        ...
        <div className="relative z-[1] max-w-[1160px] mx-auto text-center">
          ...
          <h1
            className="text-[32px] md:text-[48px] tracking-[-1px] md:tracking-[-1.4px] leading-[38px] md:leading-[54px] text-[rgb(25, 30, 73)] mb-[16px] md:mb-[20px] max-w-[680px] mx-auto"
      ...
      <section className="relative w-full py-[60px] md:py-[80px] px-4 md:px-[70px]">
        ...
        <div className="relative z-[1] max-w-[1160px] mx-auto">
          <div className="text-center mb-[36px] md:mb-[60px]">
            ...
            <h2
              className="text-[rgb(25, 30, 73)] text-[28px] md:text-[36px] tracking-[-0.8px] md:tracking-[-1.2px] leading-[34px] md:leading-[42px] max-w-[480px] mx-auto"
              style={{ fontWeight: 620, ...SV }}
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[16px] md:gap-[24px]">
            {differentiators.map((d) => (
              ...
              >
                <div className="w-[52px] h-[52px] rounded-[14px] bg-[rgb(188, 38, 155)]/8 flex items-center justify-center">
                  {d.icon}
                </div>
                <h3
                  className="text-[rgb(25, 30, 73)] text-[20px] tracking-[-0.4px] leading-[26px]"
                  style={{ fontWeight: 620, ...SV }}
                >
                  {d.title}
                </h3>
        ...
        <section key={i} className="relative z-[2] w-full py-[50px] md:py-[80px] px-4 md:px-[70px]">
          ...
          >
            ...
            <div className={`flex flex-col gap-[20px] ${s.reverse ? 'md:order-1' : 'order-2'}`}>
              ...
              <h2
                className="text-[rgb(25, 30, 73)] text-[26px] md:text-[32px] tracking-[-0.8px] md:tracking-[-1px] leading-[34px] md:leading-[38px]"
                style={{ fontWeight: 620, ...SV }}
              >
                {s.title}
              </h2>
              ...
              <div className="flex flex-col gap-[12px] mt-[8px]">
                {s.points.map((p) => (
                  <div key={p} className="flex items-start gap-[10px]">
                    <Check />
                    <span className="text-[rgb(25, 30, 73)] text-[15px] leading-[22px]" style={{ fontWeight: 500, ...SV }}>
                      {p}
                    </span>
                  </div>
                ))}
      ...
      <section className="relative z-[2] w-full py-[50px] md:py-[80px] px-4 md:px-[70px]">
        <div className="relative z-[1] max-w-[760px] mx-auto">
          <div className="bg-[rgb(25, 30, 73)] rounded-[24px] p-[28px] sm:p-[40px] md:p-[60px] text-center">
            ...
            <p className="text-[rgb(160, 169, 252)] text-[13px] md:text-[14px] mt-[4px]" style={{ fontWeight: 450, ...SV }}>
              {testimonial.role}
            </p>
          </div>
        </div>
