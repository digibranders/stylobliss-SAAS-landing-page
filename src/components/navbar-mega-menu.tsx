...
function MenuLinkList({
  ...
  return (
    <div className="flex flex-col gap-[14px]">
      <p
        className="font-medium uppercase text-[12px] tracking-[0.4px] leading-[14px] text-[rgb(71, 79, 123)]"
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-[6px] p-[16px] bg-white/80 flex-1">
        ...
        <p
          className="text-[13px] leading-[18px] text-[rgb(71, 79, 123)]"
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-[5px] flex-1">
        ...
        <p
          className="text-[13px] leading-[18px] text-[rgb(160, 169, 252)]"
          style={{ fontWeight: 450, ...SV }}
        >
          {description}
        </p>
