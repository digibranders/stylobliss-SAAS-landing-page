  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-4 md:px-[40px] py-[20px]">
        ...
        <Link
          to="/"
          className="text-[rgb(71, 79, 123)] text-[15px] hover:text-[rgb(188, 38, 155)] transition-colors"
        ...
        {submitted ? (
          ...
          <div className="w-full max-w-[480px]">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-[20px]">
              <div className="flex flex-col gap-[6px]">
                ...
                <input
                  ...
                  className="h-[48px] px-[16px] rounded-[12px] border border-[rgba(25, 30, 73, 0.15)] bg-white text-[rgb(25, 30, 73)] text-[16px] outline-none focus:border-[rgb(188, 38, 155)] transition-colors"
            ...
            <button
              ...
              className="mt-[24px] mx-auto block text-[rgb(71, 79, 123)] text-[15px] hover:text-[rgb(188, 38, 155)] transition-colors cursor-pointer bg-transparent border-none"
          ...
          <div className="w-full max-w-[580px]">
            ...
            <div className="flex items-center justify-between mt-[36px]">
              <button
                ...
                className="text-[rgb(71, 79, 123)] text-[15px] hover:text-[rgb(188, 38, 155)] transition-colors cursor-pointer bg-transparent border-none"
                style={{
                  fontWeight: 540,
