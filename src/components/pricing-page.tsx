          ...
          <div className="flex flex-col items-center gap-[8px]">
            <div className="flex items-center justify-center gap-[14px]">
              ...
              <button
                ...
                style={{ background: annual ? 'rgb(188, 38, 155)' : 'rgba(25, 30, 73, 0.15)' }}
              >
                <div
              ...
              <div key={idx} className="border-b border-[rgb(224,226,237)] first:border-t">
                ...
                >
                  ...
                  <div className="shrink-0 ml-[20px] p-[10px]">
                    ...
                    >
                      <path d="M5 1L1 5L5 9" stroke="rgb(71, 79, 123)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                </button>
                {faqOpen === idx && (
