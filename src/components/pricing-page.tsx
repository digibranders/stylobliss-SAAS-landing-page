    ...
    <div style={{ ...SV, background: '#ffffff' }}>
      ...
      <section className="relative w-full pt-[120px] md:pt-[160px] pb-[60px] md:pb-[80px] px-4 md:px-[70px]">
        <div className="relative z-[1] max-w-[1160px] mx-auto text-center">
          ...
          <h1
            className="text-[32px] md:text-[48px] tracking-[-1px] md:tracking-[-1.4px] leading-[38px] md:leading-[54px] text-[rgb(22,35,42)] mb-[16px] md:mb-[20px]"
            style={{ fontWeight: 620, ...SV }}
          >
            Simple, transparent pricing
          </h1>
          <p
            className="font-medium text-[17px] md:text-[20px] leading-[26px] md:leading-[30px] text-[rgb(7,80,86)] max-w-[520px] mx-auto mb-[32px] md:mb-[40px]"
            style={SV}
          >
          ...
          {plans.map((plan) => {
            ...
            return (
              <div
                ...
                style={plan.popular ? { boxShadow: '0 0 0 2px rgb(255,91,4), 0 8px 32px rgba(0,0,0,0.08)' } : {}}
              >
                {plan.popular && (
                  <div
                    className="absolute top-[-14px] left-[50%] -translate-x-[50%] px-[16px] py-[5px] rounded-full bg-[rgb(255,91,4)] text-white text-[12px] tracking-[0.3px]"
                    style={{ fontWeight: 620, ...SV }}
                  >
                    Most popular
                  </div>
                ...
                <p
                  className="font-medium uppercase mb-[6px] text-[rgb(7,80,86)] text-[12px] tracking-[0.42px] leading-[16px]"
                  style={{ fontFamily: 'tt-commons-mono, monospace', ...SV }}
                >
                  {plan.tagline}
                </p>
                <h3
                  className="text-[rgb(22,35,42)] text-[24px] tracking-[-0.6px] leading-[30px] mb-[16px]"
                  style={{ fontWeight: 620, ...SV }}
                >
                  {plan.name}
                </h3>
                <div className="flex items-baseline gap-[4px] mb-[8px]">
                  <span
                    className="text-[rgb(22,35,42)] text-[40px] md:text-[48px] tracking-[-1.5px] leading-[44px] md:leading-[52px]"
                    style={{ fontWeight: 620, ...SV }}
                  >
                    ${displayPrice}
                  </span>
                  <span className="text-[rgb(7,80,86)] text-[15px]" style={{ fontWeight: 450, ...SV }}>
                    {plan.period}
                  </span>
                </div>
                ...
                <Link
                  ...
                  style={{
                    fontWeight: 580,
                    background: plan.popular ? 'rgb(255,91,4)' : 'transparent',
                    color: plan.popular ? 'rgb(228,238,240)' : 'rgb(255,91,4)',
                    boxShadow: plan.popular ? 'none' : 'inset 0 0 0 2px rgb(255,91,4)',
                    textDecoration: 'none',
                    ...SV,
                  }}
                >
                ...
                <div className="flex flex-col gap-[12px]">
                  {plan.features.map((f) => (
                    <div key={f} className="flex items-start gap-[10px]">
                      <Check />
                      <span className="text-[rgb(22,35,42)] text-[14px] leading-[20px]" style={{ fontWeight: 450, ...SV }}>
                        {f}
                      </span>
                    </div>
                  ))}
      ...
      <section className="relative w-full py-[60px] md:py-[80px] px-4 md:px-[70px]">
        <div className="relative z-[1] max-w-[1160px] mx-auto">
          <div className="text-center mb-[36px] md:mb-[60px]">
            ...
            <h2
              className="text-[rgb(22,35,42)] text-[28px] md:text-[36px] tracking-[-0.8px] md:tracking-[-1.2px] leading-[34px] md:leading-[42px]"
              style={{ fontWeight: 620, ...SV }}
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-[16px] md:gap-[24px]">
            {includedFeatures.map((f) => (
              ...
              >
                <div className="w-[48px] h-[48px] rounded-[12px] bg-[rgb(255,91,4)]/8 flex items-center justify-center">
                  {f.icon}
                </div>
                <h4
                  className="text-[rgb(22,35,42)] text-[17px] tracking-[-0.3px] leading-[22px]"
                  style={{ fontWeight: 620, ...SV }}
                >
                  {f.title}
                </h4>
                <p className="text-[rgb(7,80,86)] text-[14px] leading-[21px]" style={{ fontWeight: 450, ...SV }}>
                  {f.description}
                </p>
              </div>
            ))}
      ...
      <section className="relative z-[2] w-full py-[60px] md:py-[80px] px-4 md:px-[70px]">
        <div className="relative z-[1] mx-auto flex flex-col items-center max-w-[760px]">
          <h3
            className="text-center text-[rgb(22,35,42)] text-[26px] md:text-[33px] tracking-[-0.8px] md:tracking-[-1px] leading-[34px] md:leading-[40px] mb-[30px] md:mb-[40px]"
          ...
          <div className="w-full">
            {pricingFaqItems.map((item, idx) => (
              <div key={idx} className="border-b border-[rgb(224,226,237)] first:border-t">
                ...
                >
                  <span
                    className="text-[rgb(22,35,42)] text-[16px] md:text-[18px] tracking-[-0.3px] md:tracking-[-0.4px] leading-[24px] md:leading-[30px]"
                    style={{ fontWeight: 700, ...SV }}
                  >
                    {item.question}
                  </span>
                  <div className="shrink-0 ml-[20px] p-[10px]">
                    ...
                    >
                      <path d="M5 1L1 5L5 9" stroke="rgb(7, 80, 86)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                </button>
                {faqOpen === idx && (
                  <div className="px-[10px] pb-[24px]">
                    <p className="text-[rgb(22,35,42)] text-[16px] leading-[26px]" style={{ fontWeight: 450, ...SV }}>
                      {item.answer}
                    </p>
                  </div>
                )}
