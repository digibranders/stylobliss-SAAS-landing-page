    ...
    <div style={{ fontVariationSettings: '"slnt" 0', background: '#ffffff' }}>
      ...
      <section className="relative z-[2] w-full pt-[120px] pb-[80px] md:pt-[120px] md:pb-[120px] px-4 md:px-[70px]">
        ...
        >
          {/* Header */}
          <h3
            className="text-center text-[#191E49] text-[33px] tracking-[-1px] leading-[40px] mb-[40px]"
          ...
          <div className="w-full">
            {faqItems.map((item, idx) => (
              ...
              >
                ...
                >
                  <span
                    className="text-[#191E49] text-[18px] tracking-[-0.4px] leading-[30px]"
                    style={{ fontWeight: 700 }}
                  >
                    {item.question}
                  </span>
      ...
      <section className="relative w-full pb-[60px] md:pb-[100px] px-4 md:px-[70px]">
        ...
        >
          <h3
            className="mb-[16px] text-[#191E49] text-[32px] tracking-[-1px] leading-[40px]"
            style={{ fontWeight: 700 }}
          >
            Still have questions?
          </h3>
          <p
            className="mb-[30px] text-[#191E49] text-[17px] leading-[28px] max-w-[440px]"
            style={{ fontWeight: 450 }}
          >
          ...
          <div className="flex gap-[16px] items-center">
            <a
              href="#"
              className="flex items-center justify-center h-[50px] px-[30px] rounded-[56px] text-[#BC269B] text-[15px] tracking-[-0.096px]"
              style={{
                fontWeight: 580,
                textDecoration: 'none',
            ...
            <a
              href="#"
              className="flex items-center justify-center h-[50px] px-[30px] rounded-[56px] text-[#FCFAFA] text-[15px] tracking-[-0.096px]"
              style={{
                fontWeight: 580,
