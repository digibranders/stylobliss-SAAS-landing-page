              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-[20px]">
                ...
                <div className="flex flex-col gap-[6px]">
                  ...
                  <textarea
                    ...
                    className="px-[14px] py-[12px] rounded-[10px] border border-[rgba(25, 30, 73, 0.15)] bg-[rgb(255, 255, 255)] text-[rgb(25, 30, 73)] text-[15px] outline-none focus:border-[rgb(188, 38, 155)] transition-colors resize-none"
              ...
              <div className="grid grid-cols-1 gap-[24px]">
                {offices.map((office) => (
                  <div key={office.city} className="flex flex-col gap-[4px]">
                    ...
                    <p className="text-[rgb(160, 169, 252)] text-[14px] leading-[20px]" style={SV}>
                      {office.address}
                    </p>
                    <p className="text-[rgb(160, 169, 252)] text-[14px] leading-[20px]" style={SV}>
                      {office.region}
